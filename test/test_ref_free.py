...
class TestRefFreePipeline:
    ...
    @patch("builtins.open", new_callable=mock_open, read_data="sample_groups: ['group1', 'group2']\nmode: 'ava'")
    ...
    def test_constructor_missing_enriched_file(self, mock_read_csv, mock_open, mock_isdir):
        with pytest.raises(FileNotFoundError):
            RefFreePipeline("valid_dir", 15)